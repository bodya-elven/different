(function () {
    ...
    // 1. Завантаження фонового зображення (Завжди беремо бекдроп без тексту)
    function loadOriginalPoster(e, render) {
        ...
        if (data) {
            // Завжди намагаємося взяти backdrop_path (арт без тексту)
    ...
    // 2. Обробка UI (прибирання зайвого, чистка рядків)
    function applyCardifyUI(e) {
        ...
        // Застосування налаштувань плагіна (рейтинг, статус)
        ...
        // Встановлюємо правильний бекдроп
        loadOriginalPoster(e, render);

        // Підвантаження додаткового контенту Lampa, якщо він є (схожі фільми тощо)
    ...
    function initTemplatesAndStyles() {
        // Шаблон сторінки (повністю очищений від блоків трейлера)
        Lampa.Template.add(
            "full_start_new",
