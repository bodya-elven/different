(function () {
    ...
    // 1. Створюємо власний шар для фону, щоб обійти обмеження Lampa
    function loadOriginalPoster(e, render) {
        ...
        // Завжди беремо горизонтальний бекдроп (арт без тексту)
        if (data) {
        ...
        if (tmdbPath) {
            ...
            // Видаляємо старий кастомний фон, якщо він був
            ...
            // Додаємо на самий початок контейнера
    ...
    function applyCardifyUI(e) {
        ...
        // Налаштування плагіна (рейтинг, статус)
        ...
        // Встановлюємо правильний кастомний фон
        loadOriginalPoster(e, render);

        // Підвантаження додаткового контенту Lampa (схожі фільми, актори)
    ...
    function initTemplatesAndStyles() {
        // Шаблон сторінки. Зверни увагу: додано клас full-start__buttons для сумісності з іншими плагінами!
        Lampa.Template.add(
            "full_start_new",
