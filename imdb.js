(function () {
    ...
    function initSettings() {
        ...
        // Слухач для кнопки "Очистити кеш" (з підтримкою пультів ТВ)
    ...
    function processQueue() {
        ...
        $.ajax({
            ...
            complete: function () {
                isRequesting = false;
                setTimeout(processQueue, 200); // 200мс пауза між запитами
            }
        });
    }
    ...
    // 6. ПЕРЕХОПЛЕННЯ СТВОРЕННЯ КАРТОК LAMPA
    ...
    // 7. СТАРТ ПЛАГІНА (З вирішенням проблеми таймінгів)
